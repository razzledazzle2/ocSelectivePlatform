...
import { GraduationCapIcon, MenuIcon, SparklesIcon } from 'lucide-react'
...
function ShellNav({ navigation, pathname, profile, mobile = false }) {
  return (
...
export function AppShell({ title, description, navigation, profile, children }) {
