      ...
      <CardHeader className="space-y-4 border-b border-border/70">
        ...
        <div className="space-y-2">
          ...
          {getPassageText(question) ? (
            <CardDescription className="rounded-2xl border border-border bg-muted/50 px-4 py-3 text-sm leading-7 text-foreground/80">
              {getPassageText(question)}
            </CardDescription>
          ) : null}
        </div>
      ...
      <CardContent className="space-y-6 pt-6">
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-start gap-3">
                      <span className="mt-0.5 inline-flex size-7 items-center justify-center rounded-full bg-primary text-xs font-semibold text-white">
                        {option.label}
                      </span>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-border bg-muted/50 px-4 py-4">
            ...
            <p className="mt-2 text-sm leading-7 text-foreground/80">{getWorkedSolution(question)}</p>
          </div>
        </div>
