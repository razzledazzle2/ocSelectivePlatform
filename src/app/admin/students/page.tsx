...
export default async function AdminStudentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs font-medium uppercase tracking-[0.2em] text-brand">Student operations</p>
        <h2 className="mt-2 text-3xl font-semibold text-foreground">Students</h2>
